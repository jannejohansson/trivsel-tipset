...
// Standard football standings (3/1/0) for one group's matches, ordered by
// points -> goal difference -> goals for -> team name. Mirrors the original
// computeStandings in GroupStandings.jsx.
...
function buildBracket(matches, predictions, picks, opts = {}) {
  ...
  // Resolve the eight best-third slots once every group is decided.
